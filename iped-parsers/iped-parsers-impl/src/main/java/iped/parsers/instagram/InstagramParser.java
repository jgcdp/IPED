...
import iped.parsers.telegram.ChatGroup;
...
//            }
    ...
    private void addMessage(String id, long userId, long recipientIds, long timestamp, String texto, String messageInfoJson) {
        Chat chat = null;
        if(chats == null){
            chats = new ArrayList<>();
        }
        ...
        if (chat == null){
            chat = new Chat(id, userId, recipientIds, timestamp, texto);
            chats.add(chat);
        } else {
